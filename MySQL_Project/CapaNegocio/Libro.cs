...
namespace MySQL_Project.CapaNegocio
{
    public class Libro : Ilibro
    {
        ...
        public bool Actualizar(string codLibro, string editorial, string titular)
        {
            ...
            comando.Parameters.AddWithValue("@titulo", titular);
        ...
        public bool Agregar(string codLibro, string editorial, string titular)
        {
        ...
        {
            string consulta = "select *from tlibro where " + criterio + " LIKE '%" + texto + "%'";
            MySqlCommand comando = new MySqlCommand(consulta, conexion);
